...
public record ApplicableToggle : Applicable<ToggleType> {
    ...
    public static ApplicableToggle FromExistingState(IDefaultOutfitOptionsProvider defaultOptionsProvider, ToggleType hatVisible, bool apply, bool toggle) => new() {
